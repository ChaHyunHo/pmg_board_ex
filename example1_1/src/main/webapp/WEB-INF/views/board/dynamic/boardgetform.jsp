						...
						<div class="expanel">
							...
							<div class="card" style="border-style: none;">
									<c:if test="${board.category eq 'ADMIN'}">
										<div><span class="badge badge-pill badge-warning rounded-0" style="font-size: 17px; margin: 5px;">※공지사항</span></div>
									</c:if>
									<div class="input-group mb-3">
									  ...
									  <input type="text" id="b_t" class="form-control" aria-label="Sizing example input" 
									   	aria-describedby="inputGroup-sizing-default" value="<c:out value='${board.title}' escapeXml="false" />" disabled="disabled" />
									</div>
									<div class="input-group mb-3">
									  <div class="input-group-prepend">
									...
									<div class="input-group">
									  ...
									  <textarea class="form-control" id="b_c" aria-label="With textarea" 
									  rows="16" disabled="disabled"><c:out value='${board.content}' escapeXml="false" /></textarea>
									</div>
									<div style="margin-top: 10px; margin-left: 7px;"><b>조회수 :</b> <c:out value='${board.viewCount}' escapeXml="false" /></div>
									...
									<div>
										...
										<button type="reset" class="btn btn-outline-primary" id="resetId" style="margin-top: 5px;">목록</button>
									</div>
							</div>
						</div>
					</div>
